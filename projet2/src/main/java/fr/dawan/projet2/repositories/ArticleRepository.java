...
public interface ArticleRepository extends JpaRepository<Article, Long> {
	...
	@org.springframework.data.jpa.repository.Query ("select a from Article a where marque = :idM and categorie = :idC")
	List<Article> ArticleByMarqueAndCategorie(@Param("idM") Marque idM,@Param("idC") Categorie idC);
