			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item mx-md-3"><a class="nav-link active"
						aria-current="page" href="<c:url value="/home/articles/3" context="/springbootProject"/>">Jeux Vidéo</a></li>
					<li class="nav-item mx-md-3"><a class="nav-link" href='<c:url value="/categories/1" context="/springbootProject/home"/>'>Consoles</a></li>
