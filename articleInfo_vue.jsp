	...
	<div class="container-fluid row">
		...
		<h1 class="bg-black p-4 rounded text-center text-light h3 text-center">Springboot Project</h1>
			...
			<ul class="list-group list-group-flush">
				<li class="list-group-item"><strong>Nom: </strong><c:out value="${article.nom}"/></li>
				<li class="list-group-item"><strong>Description: </strong><c:out value="${article.description}"/></li>
				<li class="list-group-item"><strong>Prix: </strong><c:out value="${article.prix}"/></li>
				<li class="list-group-item"><strong>Promotion: </strong>
				<c:if test="${article.promo == 0.0 || empty article.promo }">Pas de promotion sur cet article</c:if>
				<c:if test="${article.promo != 0.0}"><c:out value="${article.promo}"></c:out></c:if>
				</li>
